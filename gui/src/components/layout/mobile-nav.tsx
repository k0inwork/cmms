...
import { Home, ClipboardCheck, Ticket, User, Radio } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Dispatch", href: "/dispatch/mobile", icon: Radio },
      ...
      {NAV_ITEMS.map((item) => {
        ...
        return (
          ...
          >
            ...
            {active && (
              <div className="absolute bottom-[6px] h-[5px] w-[100px] rounded-full bg-slate-300" />
            )}
          </Link>
        );
      })}
